...
class RatesTimeSeriesViewModelTest {

    private lateinit var viewModel: RatesTimeSeriesViewModel
    ...
    fun setup() {
        ...
        viewModel = RatesTimeSeriesViewModel(
    ...
    fun `loadRatesTimeSeries sets error message on failure`() = runTest {
        // Given
        val exception = Exception("Failed to load rates")
